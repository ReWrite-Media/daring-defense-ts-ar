...
namespace agent {
     ...
     */
    //% block="agent drop items one at a time $direction from slot $slot quantity $quantity" blockId=agentdropitemsindividually
    export function dropItemsIndividually(direction: SixDirection, slot: number, quantity: number) {
